...
Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
'''
file_small = './data/small_file.txt'
file_big = 'data/large_file_01.txt'
very_large_file_data = './data/very_large_file_data.txt'
...
def main():
    ...
    a3 = helper.run_cipher_logic(flot_int, 'small_int')
